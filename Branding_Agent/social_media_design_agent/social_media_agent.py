...
def generate_banners(user_inputs):
    """
    ...
    prompt = f"""
    Design a high-quality, professional social media banner for a company:
    ...
    Requirements:
    1. Ensure the design is optimized for the specified social media platform (e.g., Facebook cover, Twitter header).
    2. Use the company’s branding elements such as logo, colors, and tone.
    3. Ensure text is readable, visually balanced, and engaging.
    4. Incorporate visuals or patterns that reflect the company’s mission and industry.
    5. The banner should be modern, visually appealing, and evoke the brand tone: {user_inputs['brand_tone']}.

    Create a banner that communicates innovation, professionalism, and trust.
    """

    try:
        print("\n⏳ Generating social media banners, please wait...\n")
